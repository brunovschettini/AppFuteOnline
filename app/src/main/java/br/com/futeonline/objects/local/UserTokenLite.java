package br.com.futeonline.objects.local;
...
public class UserTokenLite extends SQLiteOpenHelper {
    ...
    public UserTokenLite(Context context) {
    ...
    public void deleteOne(UserToken userToken) {
        // Get reference to writable DB
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_NAME, "id = ?",
                new String[] { String.valueOf(userToken.getId()) });
        db.close();

    }

    public UserTokenLite getPlayer(int id) {
        ...
        userToken.setId(Long.parseLong(cursor.getString(0)));
       // userToken.setName(cursor.getString(1));
